        ...
        Flow(
            storeModule = StoreModule(
                initialIconStates = listOf(
                    IconState(uuid4(), "Foo", DpOffset(100.dp, 100.dp), IconType.Start, selected = true),
                    IconState(uuid4(), "Bar", DpOffset(200.dp, 200.dp), IconType.Action),
                    IconState(uuid4(), "Baz", DpOffset(300.dp, 300.dp), IconType.End),
                )
            ),
        )
    }
